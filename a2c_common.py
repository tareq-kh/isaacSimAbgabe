...
class A2CBase(BaseAlgorithm):
    def __init__(self, base_name, params):
        ...
        if self.env_info is None:
            ...
            self.env_info['action_space'] = gym.spaces.Box(low=-1, high=1,shape= (2,), dtype=np.float32)
            #self.env_info = 
            print("self.env_info:",self.env_info, type(self.env_info))
            print("ende") 
            self.env_info['agents'] = config.get('agents', 2)
            print("self.env_info:",self.env_info, type(self.env_info))
            print("self.vec_env: ",self.vec_env)
        else:
        ...
        self.num_agents = self.env_info.get('agents', 2)
        ...
        print("self.batch_size: ",self.batch_size , "self.minibatch_size: ", self.minibatch_size)
